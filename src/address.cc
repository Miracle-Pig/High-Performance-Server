...
namespace HPS
{
    //# 1) 通过域名及端口地址返回对应条件的所有addrinfo结构体
                         ...
                         int family, int type, int protocol)
    {
        ...
        //! 若为 ipv6address serivce如：[1002:003B:456C:678D:890E:0012:234F:56G7]:3306
        ...
        //! 参数分别是：域名，端口，用户设定的 struct addrinfo 结构体，通过result指针参数返回一个指向addrinfo结构体链表的指针
