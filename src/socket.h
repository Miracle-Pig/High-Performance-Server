...
namespace HPS
{
    ...
    public:
         ...
         * @param[in] address 地址
         */
        static Socket::ptr CreateTCP(HPS::Address::ptr address);

        /**
         * @brief 创建UDP Socket(满足地址类型)
         * @param[in] address 地址
         */
        static Socket::ptr CreateUDP(HPS::Address::ptr address);
    ...
    public:
        ...
        static SSLSocket::ptr CreateTCP(HPS::Address::ptr address);
