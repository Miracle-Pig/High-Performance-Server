#ifndef __SRC_TCP_SERVER_H__
#define __SRC_TCP_SERVER_H__
...
namespace HPS
{
    ...
    public:
         ...
         */
        TcpServer(HPS::IOManager *worker = HPS::IOManager::GetThis(), HPS::IOManager *io_woker = HPS::IOManager::GetThis(), HPS::IOManager *accept_worker = HPS::IOManager::GetThis());
         ...
         * @return 返回是否绑定成功
         */
        virtual bool bind(HPS::Address::ptr addr, bool ssl = false);
