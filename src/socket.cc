...
namespace HPS
{
    ...
    Socket::ptr Socket::CreateTCP(HPS::Address::ptr address)
    {
        Socket::ptr sock(new Socket(address->getFamily(), TCP, 0));
        return sock;
    }

    Socket::ptr Socket::CreateUDP(HPS::Address::ptr address)
    {
    ...
    void Socket::setRecvTimeout(int64_t v)
    {
        ...
        //! SOL_SOCKET:套接字级别;SO_RCVTIMEO，设置接收超时时间。
        //! 在套接字级别上设置接收超时时间
    ...
    bool Socket::bind(const Address::ptr addr)
    {
        ...
        if (uaddr)
        {
            ...
            {
                HPS::FSUtil::Unlink(uaddr->getPath(), true);
            }
        }
    ...
    {
        return IOManager::GetThis()->cancelEvent(m_sock, HPS::IOManager::READ);
    }

    bool Socket::cancelWrite()
    {
        return IOManager::GetThis()->cancelEvent(m_sock, HPS::IOManager::WRITE);
    }
    ...
    SSLSocket::ptr SSLSocket::CreateTCP(HPS::Address::ptr address)
    {
