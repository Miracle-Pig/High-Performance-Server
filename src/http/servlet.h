#ifndef __SRC_HTTP_SERVLET_H__
#define __SRC_HTTP_SERVLET_H__
...
namespace HPS
{
    namespace http
    {
        ...
        public:
             ...
             * @return 是否处理成功
             */
            virtual int32_t handle(HPS::http::HttpRequest::ptr request, HPS::http::HttpResponse::ptr response, HPS::http::HttpSession::ptr session) = 0;
        ...
        public:
            ...
            /// 函数回调类型定义
            typedef std::function<int32_t(HPS::http::HttpRequest::ptr request, HPS::http::HttpResponse::ptr response, HPS::http::HttpSession::ptr session)> callback;
            ...
            virtual int32_t handle(HPS::http::HttpRequest::ptr request, HPS::http::HttpResponse::ptr response, HPS::http::HttpSession::ptr session) override;
